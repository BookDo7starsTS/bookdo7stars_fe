      ...
      {loading ? (
        ...
        <StyledCard
          ...
          <Box
            ...
            <Button variant="contained" color="primary" sx={{ width: '110px', height: '50px', display: 'flex', alignItems: 'center' }}>
              <ShoppingCartIcon sx={{ color: 'inherit', marginRight: 0.5 }} />
              장바구니
            </Button>

            <Button sx={{ border: `2px solid ${theme.palette.primary.main}`, width: '110px', height: '50px' }}>
